...
class CustomDropout(nn.Module):
    """
    Custom Dropout implementing inverted dropout scaling.
    - During training: randomly zeroes elements with probability p,
      then scales surviving activations by 1/(1-p) to keep expected value.
    - During eval: acts as identity (no dropout, no scaling).
    """
